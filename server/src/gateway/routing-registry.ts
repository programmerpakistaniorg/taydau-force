...
export const MODEL_REGISTRY: ModelCapability[] = [
  ...
  // ── Local llama.cpp Semantic Fallback Tier (LOCAL_TRUSTED / LOCAL) ────────
  {
    provider: 'local_llamacpp',
    modelId: 'local/qwen3.5-9b',
    displayName: 'Qwen 3.5 9B (Local llama.cpp GGUF Q3_K_M)',
    capabilityTier: 3,
    codeTier: 3,
    reasoningTier: 3,
    structuredOutputTier: 3,
    providerContextLimit: 8192,
    routingContextLimit: 4096,
    maxContextTokens: 4096,
    inputCostPer1M: 0.00,
    outputCostPer1M: 0.00,
    expectedBillableCostPer1M: 0.00,
    referenceCostPer1M: { input: 0.00, output: 0.00 },
    pricingProvenance: 'LOCAL_COMPUTE',
    trustLevel: 'LOCAL_TRUSTED',
    billingClassification: 'LOCAL',
    dataPolicy: 'LOCAL_ISOLATED',
    enabled: true,
  ...
  },
  {
    provider: 'local_llamacpp',
    modelId: 'qwen3.5-9b',
    displayName: 'Qwen 3.5 9B (Local llama.cpp Short Alias)',
    capabilityTier: 3,
    codeTier: 3,
    reasoningTier: 3,
    structuredOutputTier: 3,
  ...
  },
  {
    ...
    displayName: 'GLM 4.1V 9B Thinking (Local llama.cpp GGUF Q3_K_S)',
    capabilityTier: 3,
    codeTier: 3,
    reasoningTier: 3,
    structuredOutputTier: 3,
    ...
    dataPolicy: 'LOCAL_ISOLATED',
    enabled: true,
    latencyProfileMs: 1500,
  },
  {
    provider: 'local_llamacpp',
    modelId: 'glm-4.1v-9b-thinking',
    displayName: 'GLM 4.1V 9B Thinking (Local llama.cpp Short Alias)',
    capabilityTier: 3,
    codeTier: 3,
    reasoningTier: 3,
    structuredOutputTier: 3,
