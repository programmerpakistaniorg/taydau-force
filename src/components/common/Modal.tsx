...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4">
      ...
      {/* Modal Card */}
      <div
        className={`relative bg-white rounded-2xl shadow-2xl border border-slate-200 w-full ${maxWMap[maxWidth]} overflow-hidden animate-in zoom-in-95 duration-150 z-10`}
      >
        {/* Header */}
